...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#070A10] text-white overflow-hidden selection:bg-cyan-500/30 font-sans" dir="rtl">
      ...
      <nav className={`fixed top-0 right-0 h-full w-full z-50 transition-transform duration-500 ease-in-out transform ${isSidebarOpen ? 'translate-x-0' : 'translate-x-full'} lg:translate-x-0 bg-[#0B0F19]/80 backdrop-blur-2xl border-l border-white/10 shadow-2xl`}>
